...
type NamesList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Names         []string               `protobuf:"bytes,1,rep,name=names,proto3" json:"names,omitempty"` // Changed 'name' to 'names' for clarity
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type MessageList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Messages      []string               `protobuf:"bytes,1,rep,name=messages,proto3" json:"messages,omitempty"` // Changed 'message' to 'messages' for clarity
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_greet_proto_rawDesc = "" +
	...
	"\fGreetService\x12@\n" +
	"\bSayHello\x12\x16.greet_service.NoParam\x1a\x1c.greet_service.HelloResponse\x12P\n" +
	"\x14SayHelloServerStream\x12\x18.greet_service.NamesList\x1a\x1c.greet_service.HelloResponse0\x01\x12Q\n" +
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	2, // 3: greet_service.GreetService.SayHelloBiDirectionStreaming:input_type -> greet_service.HelloRequest
	...
	1, // 7: greet_service.GreetService.SayHelloBiDirectionStreaming:output_type -> greet_service.HelloResponse
